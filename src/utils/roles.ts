...
const ROLE_ROUTES: Record<PosRole, Set<string>> = {
  staff:   new Set(['/', '/kds', '/clock', '/display', '/help']),
  manager: new Set(['/', '/kds', '/clock', '/tasks', '/orders', '/cash', '/receipts', '/display', '/help']),
  owner:   new Set(['/', '/kds', '/clock', '/tasks', '/orders', '/cash', '/receipts', '/display', '/help']),
};
...
export function getVisibleNavPaths(role: PosRole): string[] {
  const allNav = ['/', '/kds', '/orders', '/cash', '/receipts', '/tasks', '/clock'];
